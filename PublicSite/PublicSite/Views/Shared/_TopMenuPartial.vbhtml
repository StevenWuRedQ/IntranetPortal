...
<div class="w-nav global-nav-2" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1" data-ix="display-global-nav-2">
    <div class="w-container">
        ...
        <nav class="w-nav-menu global-nav-open" role="navigation">
            <a class="w-nav-link global-nav-link gnl-subpage" href="/Home">Sales</a>
            <a class="w-nav-link global-nav-link gnl-subpage" href="#">Rentals</a>
            <a class="w-nav-link global-nav-link gnl-subpage" href="/Home/Agents">Agents</a>
            <a class="w-nav-link global-nav-link gnl-subpage" href="/Home/WeBuyHouse">We Buy Houses</a>
            <a class="w-nav-link global-nav-link gnl-subpage" href="/Home/About">Company</a><!--<a class="w-nav-link global-nav-link gnl-user gnl-subpage" href="#"><i class="fa fa-user"></i></a>-->
        </nav>
