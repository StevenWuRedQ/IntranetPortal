...
Webflow.define('scroll', function($) {
  ...
  function findEl(hash, e) {
    ...
    var header = $('header, body > .header, body > .w-nav, body > .global-nav');
...
Webflow.require('ix').init([
  {"slug":"display-global-nav","name":"display-global-nav","value":{"style":{},"triggers":[{"type":"scroll","selector":".global-nav","offsetTop":"11%","offsetBot":"11%","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"80px"}]}]}},
  {"slug":"ad-agent-contact-show","name":"ad-agent-contact-show","value":{"style":{},"triggers":[{"type":"hover","selector":".ad-agent-contact","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"25px"}],"stepsB":[{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  {"slug":"display-global-nav-2","name":"display-global-nav 2","value":{"style":{},"triggers":[{"type":"scroll","selector":".global-nav","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"80px"}]}]}}
]);
