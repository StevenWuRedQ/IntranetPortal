...
Namespace PortalService
    ...
    Public Interface ICommonService
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/ICommonService/SendEmailByControl", ReplyAction:="http://tempuri.org/ICommonService/SendEmailByControlResponse")>  _
        Sub SendEmailByControl(ByVal toAddresses As String, ByVal subject As String, ByVal constrolName As String, ByVal params As System.Collections.Generic.Dictionary(Of String, String))
    ...
    Partial Public Class CommonServiceClient
        ...
        Public Sub SendEmailByControl(ByVal toAddresses As String, ByVal subject As String, ByVal constrolName As String, ByVal params As System.Collections.Generic.Dictionary(Of String, String)) Implements PortalService.ICommonService.SendEmailByControl
            MyBase.Channel.SendEmailByControl(toAddresses, subject, constrolName, params)
        End Sub
