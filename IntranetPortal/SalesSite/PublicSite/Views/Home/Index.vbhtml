                ...
                <ul class="w-list-unstyled w-clearfix featured-agents-list">
                    <li class="featured-agents-list-item">
                        <a class="w-inline-block featured-agents-list-item-link" href="#">
                            <img class="featured-agents-list-item-pic" src="images/agent-1.jpg" width="80" alt="54b54de85608e3f4389dce5b_agent-1.jpg">
                            <div>Richard C.</div>
                        </a>
                    </li>
                    <li class="featured-agents-list-item">
        ...
        <div class="w-row">
            <div class="w-col w-col-3">
                <a class="w-inline-block featured-listings-item" href="#">
                    <img class="featured-listings-item-pic" src="images/listing-1.jpg" width="190" alt="54b564547f72257c2dde4278_listing-1.jpg">
                    <div class="featured-listings-item-price"><span class="font-awesome"><i class="fa fa-tag"></i></span>&nbsp;$5,795,000</div>
