...
if (!DevExpress.MOD_WIDGETS_BASE) {
    ...
    (function($, DX, undefined) {
        ...
        ui.NativeScrollableStrategy = DX.Class.inherit({
            ...
            validate: function() {
                return !this.option("disabled") && (this._allowedDirection() || this._isDirection(VERTICAL))
            },
    ...
    (function($, DX, undefined) {
        ...
        ui.SimulatedScrollableStrategy = DX.Class.inherit({
            ...
            _allowedDirections: function() {
                return {
                        vertical: this._isDirection(VERTICAL) && this._scrollers[VERTICAL]._minOffset < 0,
                        horizontal: this._isDirection(HORIZONTAL) && this._scrollers[HORIZONTAL]._minOffset < 0
                    }
            },
            scrollBy: function(distance) {
                this._prepareDirections(true);
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxTextEditor", ui.dxEditor.inherit({
            ...
            _renderClearButton: function() {
                var $clearButton = $("<span>").addClass(TEXTEDITOR_CLEAR_BUTTON_CLASS).append($("<span>").addClass(TEXTEDITOR_CLEAR_ICON_CLASS)).on("dxclick", $.proxy(this._handleClearValue, this));
            ...
            _renderEmptinessEvent: function() {
                ...
                $input.on("input keyup blur", $.proxy(this._toggleEmptinessEventHandler, this));
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxDropDownEditor", ui.dxTextBox.inherit({
            ...
            _deviceHasTouchScreen: function() {
                ...
                return DevExpress.support.touch || device.platform === "win8" && (device.phone || device.tablet)
            },
        ...
        DX.registerComponent("dxNumberBox", ui.dxTextEditor.inherit({
            ...
            _handleValueChangeEvent: function(e) {
                ...
                if (typeof input.checkValidity === "function")
                    input.checkValidity();
                value = value.replace(",", ".");
                $input.focusout($.proxy(this._trimInputValue, this)).on("invalid", $.proxy(this._inputInvalidHandler, this));
            ...
            _renderPlaceholder: function() {
                if (this.option("mode") === "number")
                    this._input().attr("placeholder", this.option("placeholder"));
                else
                    this.callBase()
            },
        ...
        DX.registerComponent("dxOverlay", ui.Widget.inherit({
            ...
            _makeVisible: function() {
                ...
                if (this._isHidingActionCancelled) {
                    ...
                    DX.utils.triggerShownEvent(that.content());
            ...
            _makeHidden: function() {
                ...
                if (hidingArgs.cancel) {
                    ...
                    DX.utils.triggerHidingEvent(that.content());
        ...
        DX.registerComponent("dxPopover", ui.dxPopup.inherit({
            ...
            _normalizePosition: function() {
                ...
                if (!position.viewportOffset)
                    position.viewportOffset = DEFAULT_VIEWPORT_OFFSET;
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxDatePickerRoller", ui.dxScrollable.inherit({
            ...
            _renderSelectedItemFrame: function() {
                $("<div>").addClass(DATEPICKER_ROLLER_ITEM_SELECTED_FRAME_CLASS).appendTo(this._$container)
            },
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxSelectBox", ui.dxAutocomplete.inherit({
            ...
            _renderTags: function() {
                ...
                this._element().toggleClass(EMPTY_INPUT_CLASS, !values.length);
                this._input().val(values.length ? " " : null)
            },
