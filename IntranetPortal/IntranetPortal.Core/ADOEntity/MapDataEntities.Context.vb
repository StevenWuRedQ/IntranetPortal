...
Partial Public Class MapDataEntitiesContainer
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=MapDataEntitiesContainer")
    End Sub
    ...
    Public Overridable Property building_0117() As DbSet(Of building_0117)
