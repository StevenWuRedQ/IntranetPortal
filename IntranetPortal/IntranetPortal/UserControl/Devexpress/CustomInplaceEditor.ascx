...
<%@ Control Language="vb" AutoEventWireup="true" Inherits="IntranetPortal.CustomInplaceEditor" CodeBehind="CustomInplaceEditor.ascx.vb" %>
...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v15.1, Version=15.1.6.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler.Controls"
    TagPrefix="cc1" %>
...
<table runat="server" id="mainContainer" style="width: 100%; height: 100%">
    <tr>
        ...
        <td runat="server" id="buttonContainer" class="dx-p2" style="vertical-align: top">
            ...
            <div>
                <cc1:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" Visible="false"
