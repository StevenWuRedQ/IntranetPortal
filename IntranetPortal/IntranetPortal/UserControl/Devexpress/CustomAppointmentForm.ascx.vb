...
Partial Public Class CustomAppointmentForm
    ...
    Protected Overrides Function GetChildEditors() As ASPxEditBase()
        Dim edits() As ASPxEditBase = {lblSubject, tbSubject, lblLocation, tbLocation, lblStartDate, edtStartDate, lblEndDate, edtEndDate, tbDescription, GetMultiResourceEditor()}
