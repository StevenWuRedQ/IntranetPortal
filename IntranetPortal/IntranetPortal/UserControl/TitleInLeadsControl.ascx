<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="TitleInLeadsControl.ascx.vb" Inherits="IntranetPortal.TitleInLeads" %>
...
<div style="padding-top: 5px">
    <div style="height: 850px; overflow:auto" id="home_owner_content">
        ...
        <div class="short_sale_content">
            ...
            <div class="ss_form" id="ddd" style="display:none">
