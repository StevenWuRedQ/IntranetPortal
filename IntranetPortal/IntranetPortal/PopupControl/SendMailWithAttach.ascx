<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SendMailWithAttach.ascx.vb" Inherits="IntranetPortal.SendMailWithAttach" %>
<script type="text/javascript">
    ...
    function ShowEmailPopup(bble) {
        ...
        if (!loaded) {
            popupSendEmailAttachClient.PerformCallback("Show");
            //loaded = true;
        }
        else {
            popupSendEmailAttachClient.Show();
        }
    }
    ...
    function ShowMailmessage(mailId) {
        ShowEmail = true;
        popupSendEmailAttachClient.PerformCallback("ShowMail|" + mailId);
    }
...
<dx:ASPxPopupControl ID="PopupSendMail" runat="server" ClientInstanceName="popupSendEmailAttachClient"
    ...
    <HeaderTemplate>
        <div class="clearfix">
            ...
            <div class="pop_up_buttons_div">
                <i class="fa fa-times icon_btn" onclick="popupSendEmailAttachClient.Hide()"></i>
            </div>
        </div>
    </HeaderTemplate>
    <ContentCollection>
        <dx:PopupControlContentControl runat="server" ID="PopupContentSendMail" Visible="false">
            <div class="clearfix">
                ...
                <div class="popup_btns">
                    ...
                    <input type="button" class="rand-button short_sale_edit" style="background: #77787b" value="Cancel" onclick="popupSendEmailAttachClient.Hide()">
                </div>
            </div>
        </dx:PopupControlContentControl>
    </ContentCollection>
    <ClientSideEvents EndCallback="SendMailEndCallback"  />
</dx:ASPxPopupControl>
