    ...
    <div id="LeadTaxSearchCtrl" ng-controller="LeadTaxSearchCtrl">
        ...
        <div class="ss_form">
            ...
            <div class="ss_border">
                <ul class="ss_form_box clearfix">
                    <li class="ss_form_item ">
                        <label class="ss_form_input_title">Property Taxes</label><input class="ss_form_input" ng-model="DocSearch.LeadResearch.propertyTaxes" /></li>
                    <li class="ss_form_item ">
                        <label class="ss_form_input_title">Water Charges</label><input class="ss_form_input" ng-model="DocSearch.LeadResearch.waterCharges" /></li>
                    <li class="ss_form_item ">
                    ...
                    <li class="ss_form_item ">
                        <label class="ss_form_input_title">ECB Violation</label><input class="ss_form_input" ng-model="DocSearch.LeadResearch.ecbViolation" /></li>
                </ul>
            </div>
        </div>
        <div class="ss_form">
            ...
            <div class="ss_border">
                <ul class="ss_form_box clearfix">
                    ...
                    <li class="ss_form_item_line" style="list-style: none">
                        ...
                        <li class="clear-fix" style="list-style: none">
                        </li>
                </ul>
            </div>
        </div>
