        ...
        <dx:PopupControlContentControl runat="server" ID="PopupContentSendMail">
            <div class="clearfix">
                ...
                <div style="margin-top: 10px">
                    <dx:ASPxHtmlEditor ID="EamilBody" runat="server" Height="300px" Width="100%"></dx:ASPxHtmlEditor>
                </div>

                <div class="popup_btns">
                    <input type="button" class="rand-button short_sale_edit bg_color_blue" value="Send">
