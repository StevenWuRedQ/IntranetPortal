...
Public Class CacheAvoidModule
    ...
    Public Sub OnEndRequest(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If app.Context.Response.ContentType = "application/x-javascript" OrElse app.Context.Response.ContentType = "application/javascript" OrElse app.Context.Response.ContentType = "text/css" Then
