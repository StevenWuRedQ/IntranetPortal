    ...
    <div class="ss_border">
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
                ...
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="POA_Upload" file-model="FormData.preclosing.POA_Upload"></pt-file>
            </li>
        </ul>
...
<div class="ss_form ">
    ...
    <div class="ss_border">
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="WILLS_Upload" file-model="FormData.preclosing.WILLS_Upload"></pt-file>
            </li>
...
<div class="ss_form ">
    ...
    <div class="ss_border">
        <ul class="ss_form_box clearfix">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="HUD_Upload" file-model="FormData.preclosing.HUD_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Approval_Upload" file-model="FormData.preclosing.Approval_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Servicing_Agrement_POA_Upload" file-model="FormData.preclosing.Servicing_Agrement_POA_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Contract_of_Sale_Upload" file-model="FormData.preclosing.Contract_of_Sale_Upload"></pt-file>
            </li>
...
<div class="ss_form ">
    ...
    <div class="ss_border">
        <ul class="ss_form_box clearfix">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Filing_Receipts_Upload" file-model="FormData.preclosing.Filing_Receipts_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Proof_of_Publication_Upload" file-model="FormData.preclosing.Proof_of_Publication_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Operating_Agreeements_Upload" file-model="FormData.preclosing.Operating_Agreeements_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="By_Laws_of_Corp_Upload" file-model="FormData.preclosing.By_Laws_of_Corp_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Certificate_of_Good_Standing_Upload" file-model="FormData.preclosing.Certificate_of_Good_Standing_Upload"></pt-file>
            </li>
        </ul>
    </div>
</div>
<div class="ss_form ">
    ...
    <div class="ss_border">
        <ul class="ss_form_box clearfix">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Deed_reverting_title_Upload" file-model="FormData.preclosing.Deed_reverting_title_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Correction_deed_Upload" file-model="FormData.Correction_deed_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Closing_Deed_and_Acris_Upload" file-model="FormData.Closing_Deed_and_Acris_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="no_consideration_affidavit_Upload" file-model="FormData.no_consideration_affidavit_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="no_demand_affidavit_Upload" file-model="FormData.no_demand_affidavit_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="original_marriage_death_certificates_Upload" file-model="FormData.original_marriage_death_certificates_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Original_letter_of_Administration_Upload" file-model="FormData.Original_letter_of_Administration_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Original_POA_Upload" file-model="FormData.Original_POA_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Affidavit_of_full_force_Upload" file-model="FormData.Affidavit_of_full_force_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="Termination_of_Contract_Upload" file-model="FormData.Termination_of_Contract_Upload"></pt-file>
            </li>
        </ul>
        <ul class="ss_form_box clearfix">
            <li class="ss_form_item ">
            ...
            <li class="ss_form_item ">
                <label class="ss_form_input_title ">Upload</label>
                <pt-file file-bble="Form.FormData.BBLE" upload-type="uploadType" file-id="LLC_Resignation_and_Assignment_LLC_Upload" file-model="FormData.LLC_Resignation_and_Assignment_LLC_Upload"></pt-file>
            </li>
        </ul>
    </div>
</div>
