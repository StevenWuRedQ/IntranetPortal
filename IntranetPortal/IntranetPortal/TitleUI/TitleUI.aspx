<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TitleUI.aspx.vb" Inherits="IntranetPortal.TitleUI" MasterPageFile="~/Content.Master" %>
...
<%@ Register Src="~/TitleUI/TitleTab.ascx" TagPrefix="uc1" TagName="TitleTab" %>
<%@ Register Src="~/TitleUI/TitleCaseList.ascx" TagPrefix="uc1" TagName="TitleCaseList" %>
    ...
    <dx:ASPxSplitter ID="ASPxSplitter1" runat="server" Height="100%" Width="100%" ClientInstanceName="splitter" Orientation="Horizontal" FullscreenMode="true">
        <Panes>
            ...
            <dx:SplitterPane Name="listPanel" ShowCollapseBackwardButton="True" MinSize="100px" MaxSize="400px" Size="280px" PaneStyle-Paddings-Padding="0">
                ...
                <ContentCollection>
                    <dx:SplitterContentControl ID="SplitterContentControl1" runat="server">
                        <uc1:TitleCaseList runat="server" id="TitleCaseList" />
            ...
            <dx:SplitterPane ShowCollapseBackwardButton="True" ScrollBars="None" PaneStyle-Paddings-Padding="0px" Name="dataPane">
                ...
                <ContentCollection>
                    <dx:SplitterContentControl>
                        <div id="TitleCtrl" ng-controller="TitleCtrl" style="align-content: center;">
                            <!-- Nav tabs -->
                            <div class="legal-menu row" style="margin: 0;">
                                <ul class="nav nav-tabs clearfix" role="tablist" style="background: #ff400d; font-size: 18px; color: white; height: 70px">
                                    <li class="active short_sale_head_tab">
                                        <a href="#TitleTab" role="tab" data-toggle="tab" class="tab_button_a">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="TitleTab">
                                    <uc1:TitleTab runat="server" id="TitleTab" />
                                </div>
    ...
    <script type="text/javascript">
        ...
        function LoadCaseData(bble) {
            $(document).ready(function () {
                ...
                var scope = angular.element('#TitleCtrl').scope();
                scope.init(bble);
            });
        }

        portalApp = angular.module('PortalApp');
        portalApp.controller('TitleCtrl', ['$scope', '$http', '$timeout', '$interpolate', 'ptCom', 'ptShortsSaleService', 'ptLeadsService', 'ptContactServices', 'ptConstructionService', function ($scope, $http, $timeout, $interpolate, ptCom, ptShortsSaleService, ptLeadsService, ptContactServices, ptConstructionService) {
