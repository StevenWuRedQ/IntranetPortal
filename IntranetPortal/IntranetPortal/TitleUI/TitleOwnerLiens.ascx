...
<tab-heading>
    ...
    <div id="liens{{$index}}_content" class="ss_border" style="border-top: 0; min-height: 300px; position: relative">
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[1]" ng-click="setPopVisible(owner, 2)">
            <div class="panel-heading">Lis Pendens: {{owner.Lis_Pendens_Status}}</div>
            <div class="panel-body">
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[2]" ng-click="setPopVisible(owner, 3)">
            <div class="panel-heading">Judgement: {{owner.Judgements_Status}}</div>
            <div class="panel-body">
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[3]" ng-click="setPopVisible(owner, 4)">
            <div class="panel-heading">ECB: {{owner.ECB_Notes_Status}}</div>
            <div class="panel-body">
                <ul class="col-md-6">
                    <li ng-repeat="n in owner.ECB_Notes"><span class="label label-primary">Notes&nbsp;{{$index + 1}}:</span><br />
                        {{n.content}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[4]" ng-click="setPopVisible(owner, 5)">
            <div class="panel-heading">PVB: {{owner.PVB_Notes_Status}}</div>
            <div class="panel-body">
                <ul class="col-md-6">
                    <li ng-repeat="n in owner.PVB_Notes"><span class="label label-primary">Notes&nbsp;: {{$index + 1}}:</span><br />
                        {{n.content}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[5]" ng-click="setPopVisible(owner, 6)">
            <div class="panel-heading">Bankruptcy: {{owner.Bankruptcy_Status}}</div>
            <div class="panel-body">
                <ul class="col-md-6">
                    <li ng-repeat="n in owner.Bankruptcy_Notes"><span class="label label-primary">Notes&nbsp;{{$index + 1}}:</span><br />
                        {{n.content}}</li>
                </ul>
            </div>
        </div>
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[6]" ng-click="setPopVisible(owner, 7)">
            <div class="panel-heading">UCC: {{owner.UCCs_Status}}</div>
            <div class="panel-body">
        ...
        <div class="panel panel-default panel-condensed" ng-show="owner.shownlist[7]" ng-click="setPopVisible(owner, 8)">
            <div class="panel-heading">Federal Tax: {{owner.FederalTaxLiens_Status}}</div>
            <div class="panel-body">
            ...
            <div data-options="dxTemplate:{ name: 'content' }">
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==1">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" ng-model="owner.Mortgages_Status">
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==2">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.Lis_Pendens_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==3">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.Judgements_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==4">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.ECB_Notes_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==5">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.PVB_Notes_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==6">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.Bankruptcy_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==7">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.UCCs_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==8">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.FederalTaxLiens_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
                ...
                <div class="ss_form" ng-show="owner.popVisible && owner.popStep==9">
                    ...
                    <div class="ss_border" style="max-height: 600px; overflow-y: scroll">
                        <div class="input-group">
                            <span class="input-group-addon">Status</span>
                            <select class="form-control" ng-model="owner.MechanicsLiens_Status">
                                <option>Pending</option>
                                <option>Clear</option>
                            </select>
                        </div>
