                ...
                <div ng-repeat="mortgage in mortgages|filter:{DataStatus:'!3'}">
                    ...
                    <ul class="ss_form_box clearfix">
                        ...
                        <li class="ss_form_item" ng-show="mortgage.LenderName!='N/A'">
                            ...
                            <input type="text" class="ss_form_input" ng-model="mortgage.LoanAmount" number-mask maskformat='money' readonly="readonly">
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div >
                    <ul class="ss_form_box clearfix">
                        <li class="ss_form_item">
                            ...
                            <input class="ss_form_input" ng-model="contract.contractPrice" number-mask maskformat='money' readonly="readonly"/>
                        </li>
                        <li class="ss_form_item ">
                            <label class="ss_form_input_title">Down Payment</label>
                            <input class="ss_form_input" ng-model="contract.downPayment" number-mask maskformat='money' readonly="readonly"/>
                        </li>
                    </ul>
                </div>
            </div>
