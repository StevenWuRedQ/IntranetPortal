<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="Login2.aspx.vb" Inherits="IntranetPortal.Login2" %>
                        ...
                        <dx:PanelContent>
                            ...
                            <table style="width: 100%; padding: 2px;text-align:left;">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="padding:2px;">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" AssociatedControlID="tbPassword" Text="Employee:" />
                                    </td>
                                    <td style="padding:2px;">
                                        <dx:ASPxComboBox runat="server" ID="cbEmps" Width="100%"></dx:ASPxComboBox>
                                    </td>
                                </tr>
                                <tr>
