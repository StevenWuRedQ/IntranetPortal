...
module.exports = function (config) {
    config.set({
        ...
        files: ['https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js',
            ...
            'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.17/angular-resource.min.js',
            'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.17/angular-animate.min.js',
            'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.17/angular-aria.min.js',
            'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.17/angular-sanitize.js',
            'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.17/angular-mocks.js',
            'http://cdn3.devexpress.com/jslib/15.1.6/js/dx.webappjs.js',
