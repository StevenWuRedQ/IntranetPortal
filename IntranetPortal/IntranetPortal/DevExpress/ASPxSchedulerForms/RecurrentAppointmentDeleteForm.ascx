...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" Inherits="IntranetPortal.RecurrentAppointmentDeleteForm" Codebehind="RecurrentAppointmentDeleteForm.ascx.vb" %>
...
<table class="dxscBorderSpacing" style="width:100%; height:100%">
	...
	<tr>
		<td class="dx-ac dxscCellWithPadding" <%= DevExpress.Web.ASPxClasses.Internal.RenderUtils.GetAlignAttributes(Me, "center", Nothing)%> style="width:100%" colspan="2">
