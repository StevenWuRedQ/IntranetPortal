...
<%@ Control Language="vb" AutoEventWireup="true" Inherits="IntranetPortal.GotoDateForm" Codebehind="GotoDateForm.ascx.vb" %>
...
<table class="dxscBorderSpacing" style="width:100%; height:100%">
	...
	<tr>
		<td class="dx-ac dxscCellWithPadding" <%= DevExpress.Web.ASPxClasses.Internal.RenderUtils.GetAlignAttributes(Me, "center", Nothing)%> colspan="2" style="width:100%">
