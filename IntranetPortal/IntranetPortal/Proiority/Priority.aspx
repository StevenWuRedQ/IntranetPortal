                ...
                <div style="width: 660px; font-family: 'Source Sans Pro'">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="property_info">
                            ...
                            <div style="width: 330px; border-right: 1px solid #dde0e7; float: left; height: 820px">
                                <div class="homeowner_content clearfix">
                                    ...
                                    <div class="form_div_node form_div_no_float form_div_node_no_under_line" style="width: 100%">
                                        ...
                                        <%--expanll list--%>
                                        <div style="margin-left: 14px; margin-top: 5px; border-left: 3px solid #dde0e7" class="clearfix">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div class="clearfix homeowner_info_label">
                                                    ...
                                                    <div class="clearfix homeowner_info_label" style="padding-left:0px;">
                                                        <div>
                                                            <i class="fa fa-phone homeowner_info_icon"></i>
                                ...
                                <%------end-----%>
                                <%--right side--%>
                                <div style="width: 330px; border-right: 1px solid #dde0e7">
                                </div>
                                <%------end-----%>
                                ...
                                <div style="height: 800px; overflow: auto; display: none" id="prioity_content">
                                    <%--refresh label--%>
                            ...
                            <div class="tab-pane clear-fix" id="home_owner">
                                <%--left side--%>
                                <div style="width: 330px; border-right: 1px solid #dde0e7; float: left">
                                    <div class="homeowner_content clearfix">
                                        ...
                                        <div class="form_div_node" style="width: 100%">
                                            <span class="form_input_title">age</span>
                            ...
                            <div class="tab-pane" id="documents">3</div>
