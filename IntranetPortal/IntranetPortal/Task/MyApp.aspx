<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MyApp.aspx.vb" Inherits="IntranetPortal.MyApp" MasterPageFile="~/Content.Master" %>
            ...
            <dx:SplitterPane Name="leadPanel" ShowCollapseBackwardButton="True" MinSize="100px" MaxSize="400px" Size="280px" PaneStyle-Paddings-Padding="2px">
                <ContentCollection>
                    <dx:SplitterContentControl ID="SplitterContentControl1" runat="server">
                        <uc1:OriginatedListControl runat="server" ID="OriginatedListControl" />
