...
The courts no longer consider this proper service. "></i></span>
		...
		<div ng-show="LegalCase.ForeclosureInfo.NoteIsPossess">
			<ul class="ss_form_box clearfix">
				...
				<li class="ss_form_item">
					...
					<span style='text-transform: none'><i class='fa fa-question-circle tooltip-examples icon-btn color_blue' title='If a note does not have the proper allonge, or a note endorsement, then there is no proof of proper transfer. '></i></span>
	...
	<div class="ss_form">
		...
		<ul class="ss_form_box clearfix">
			...
			<li class="ss_form_item">
				<label class="ss_form_input_title {{isPassOrEqualByDays(LegalCase.ForeclosureInfo.LisPendesDate, LegalCase.ForeclosureInfo.LisPendesRegDate, 5)}}">
		...
		<div ng-show="LegalCase.ForeclosureInfo.AccelerationLetterReview">
			<ul class="ss_form_box clearfix">
				...
				<li class="ss_form_item">
					...
					<span style='text-transform: none'><i class='fa fa-question-circle tooltip-examples icon-btn color_blue' title='Lender must register Acceleration letter within 3 days of the date of said letter'></i></span>
