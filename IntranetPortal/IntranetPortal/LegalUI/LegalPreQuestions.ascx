...
<form>
    <div class="row">
        ...
        <pt-radio name="IsDuringOrPriorMarriage" ng-model="IsDuringOrPriorMarriage" trueValue="prior" false="during"></pt-radio>

        <h4>Is there a divorce decree we can see</h4>
        <pt-radio name="IsDivorceDecree" ng-model="IsDivorceDecree"></pt-radio>

        <h4>Is there a contract?</h4>
        <pt-radio name="IsContract" ng-model="IsContract"></pt-radio>

        <h4>Is contract for our viewing?</h4>
        <pt-radio name="IsContractViewable" ng-model="IsContractViewable"></pt-radio>

        <h4>Have we tried to offer that person money to agree to participate?</h4>
        <pt-radio name="IsOfferMoney" ng-model="IsOfferMoney"></pt-radio>

        <h4>Is there a current foreclose on the property?</h4>
        <pt-radio name="IsFC" ng-model="IsFC"></pt-radio>

        <h4>Is there refusing party trying to work out with the bank?</h4>
        <pt-radio name="IsRefusingWorkout" ng-model="IsRefusingWorkout"></pt-radio>

        <h4>How Many units of living space are there?</h4>


        <h4>Who is paying the utilities currently?</h4>
        <input ng-model="WhoPayUtilities" />
    </div>
</form>