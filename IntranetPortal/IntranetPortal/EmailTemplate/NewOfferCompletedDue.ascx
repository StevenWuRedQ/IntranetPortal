<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="NewOfferCompletedDue.ascx.vb" Inherits="IntranetPortal.NewOfferCompletedDue" %>
    ...
    <table style="margin-left: 15px; border: 1px solid black; border-collapse: collapse; border-spacing: 0px;" border="1" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= offer.Team %></td>
                <td><%= HumanizeTimeSpan(DateTime.Now - offer.UpdateDate) %></td>
            </tr>
            <% Next %>
        </tbody>
    </table>
