...
<asp:Content runat="server" ContentPlaceHolderID="MainContentPH">
    ...
    <div>
        ...
        <dx:ASPxGridView runat="server" ID="ASPxGridView1" Width="100%" ClientInstanceName="gridLeadsData" OnCustomCallback="gridLeadsData_CustomCallback" KeyFieldName="ID" OnDataBinding="gridLeadsData_DataBinding" OnRowUpdating="gridLeadsData_RowUpdating">
            <Columns>
