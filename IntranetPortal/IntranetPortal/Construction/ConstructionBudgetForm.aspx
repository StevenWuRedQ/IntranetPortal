            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <tr ng-repeat="d in data.Form">
                        ...
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.materials" number-mask maskformat='money' /></td>
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.labor" number-mask maskformat='money' /></td>
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.contract" number-mask maskformat='money' ng-change="update(d)" /></td>
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.toDay" number-mask maskformat='money' ng-change="update(d)" /></td>
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.paid" number-mask maskformat='money' ng-change="update(d)" /></td>
                        <td class="col-sm-1">
                            <input type="text" ng-model="d.balance" number-mask maskformat='money' readonly /></td>
                    </tr>
                    <tr style="background-color: yellow; font-weight: bolder">
                        ...
                        <td></td>
                        <td>
                            <input type="text" style="background-color: yellow" ng-model="data.Total.contract" number-mask maskformat='money' readonly /></td>
                        <td>
                            <input type="text" style="background-color: yellow" ng-model="data.Total.toDay" number-mask maskformat='money' readonly /></td>
                        <td>
                            <input type="text" style="background-color: yellow" ng-model="data.Total.paid" number-mask maskformat='money' readonly /></td>
                        <td>
                            <input type="text" style="background-color: yellow" ng-model="data.Total.balance" number-mask maskformat='money' readonly /></td>
                    </tr>
                </tbody>
            </table>
