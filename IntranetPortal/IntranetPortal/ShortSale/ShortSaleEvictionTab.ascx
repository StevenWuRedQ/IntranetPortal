    ...
    <div class="ss_form">
        ...
        <ul class="ss_form_box clearfix">
            ...
            <li class="ss_form_item">
                ...
                <input type="radio" id="key_Notice30Day_yes" data-item="Military" data-radio="Y" class="ss_form_input" name="Notice30Day" value="YES">
                <label for="key_Military_yes" class="input_with_check"><span class="box_text">Yes</span></label>

                <input type="radio" id="none_Notice30Day_no" data-item="Military" name="Notice30Day" value="NO">
                <label for="none_pdf_checkey_no" class="input_with_check"><span class="box_text">No</span></label>
            ...
            <li class="ss_form_item">
                ...
                <input class="ss_form_input " data-item="Notice30Day" data-item-type="1">
            </li>
            <li class="ss_form_item">
