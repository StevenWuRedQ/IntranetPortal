...
<div data-array-index="0" data-field="Occupants" class="ss_array" style="display: none">
    ...
    <h3 class="ss_form_title title_with_line" style="cursor:pointer" onclick="expand_array_item(this)"><span class="title_index title_span">Occupant __index__1</span> &nbsp;<i class="fa fa-plus-circle icon_btn color_blue tooltip-examples" onclick="AddArraryItem(this)" title="Add"></i>
